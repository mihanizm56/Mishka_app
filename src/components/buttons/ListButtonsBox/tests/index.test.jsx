...
describe("ButtonWriteReview test", () => {
	...
	describe("test props", () => {
		...
		it("check default callback prop on prev button", () => {
			ListButtonsBox.defaultProps.onPrevClick = onPrevClick;
			const component = shallow(<ListButtonsBox />);
			expect(
				component
					.find(InteractiveSVGIcon)
		...
		it("check default callback prop on next button", () => {
			ListButtonsBox.defaultProps.onNextClick = onNextClick;
			const component = shallow(<ListButtonsBox />);
			expect(
				component
					.find(InteractiveSVGIcon)
